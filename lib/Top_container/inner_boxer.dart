...
class innerboxer extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<innerboxer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('INNER BOXER',style: TextStyle(color: Colors.black,fontFamily: 'Rosmatika (DEMO)',fontSize: 15.0),),
