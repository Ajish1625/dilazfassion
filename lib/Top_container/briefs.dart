...
import 'package:demodezi/Top_container/add_cart_page/Add_cart.dart';
import 'package:demodezi/Top_container/filter/filterpage.dart';
import 'package:demodezi/product_detail/productdetail_page.dart';
...
class _State extends State<briefs> {
    ...
    return Scaffold(
      ...
      AppBar(
        ...
        actions: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 0.40),
            child: IconButton(
                onPressed: (){
                  Navigator.push(context,
