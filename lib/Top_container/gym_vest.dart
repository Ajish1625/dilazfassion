...
class gymvest extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<gymvest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('GYM VEST',style: TextStyle(color: Colors.black,fontFamily: 'Rosmatika (DEMO)',fontSize: 15.0),),
