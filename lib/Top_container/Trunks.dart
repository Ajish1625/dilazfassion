...
class Trunks extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<Trunks> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('TRUNKS',style: TextStyle(color: Colors.black,fontFamily: 'Rosmatika (DEMO)',fontSize: 15.0),),
