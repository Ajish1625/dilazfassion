...
class longwear extends StatefulWidget {
  @override
  _State createState() => _State();
}

class _State extends State<longwear> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('LONG WEAR',style: TextStyle(color: Colors.black,fontFamily: 'Rosmatika (DEMO)',fontSize: 15.0),),
